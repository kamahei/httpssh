...
Tagged releases are built by GitHub Actions from tags like `v0.3.0`.

| Asset | Purpose |
|---|---|
| `httpssh-relay-windows-amd64-v0.3.0.exe` | Windows x64 relay binary |
| `httpssh-mobile-android-v0.3.0.apk` | Signed Android APK |
